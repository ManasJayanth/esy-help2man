...
`esy-help2man` is sample package, [`hello`](https://github.com/esy/test-hello-c), packaged for [`esy`](https://esy.sh/).
...
## How to use `esy-help2man`?

`esy-help2man` can be used from both NPM and directly from Github.

### From NPM 

`esy-help2man` is deployed on NPM can be found
[here](https://www.npmjs.com/package/TODO).

You can simply run `esy add esy-help2man` to install it, or specify it in
...
{
  "dependencies": {
    "esy-help2man": "esy-packages/esy-help2man"
  }
}
```
...
```diff
  "dependencies": {
+   "esy-help2man": "esy-packages/esy-help2man#<commit hash>"
  }
```
